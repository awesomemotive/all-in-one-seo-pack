...
if ( ! class_exists( 'All_in_One_SEO_Pack_Opengraph' ) ) {
	class All_in_One_SEO_Pack_Opengraph extends All_in_One_SEO_Pack_Module {
		 ...
		 * @since 2.4      #1035 Adds filter:aioseop_brackets and validates auto generated.
		 *
		...
		function add_meta() {
			...
			// Flag that indicates if description is auto generated
			...
			if ( ! empty( $description ) ) {
				...
				if ($is_autogenerated && empty( $this->options['aiosp_opengraph_description_shortcodes'] ) )
					$description = apply_filters( 'aioseop_brackets', $description );
