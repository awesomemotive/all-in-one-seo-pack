	...
	class All_in_One_SEO_Pack_Sitemap extends All_in_One_SEO_Pack_Module {
		...
		public function sitemap_warning( $files ) {
			...
			if ( $conflict ) {
				...
				$msg .= "<input type='submit' name='aioseop_sitemap_delete_files' class='button-primary' style='margin: 0 5px 10px 0;' value='" . __( 'Delete Conflicting Files', 'all-in-one-seo-pack' ) . "'>";
				$msg .= "<input type='submit' name='aioseop_sitemap_rename_files' class='button-secondary' style='margin: 0 0 10px 0;' value='" . __( 'Rename Conflicting Files', 'all-in-one-seo-pack' ) . "'> ";
