...
var aioseopPreviewTimeout = 0;

var aioseopPreviewIsGutenberg              = aioseop_preview_snippet.isGutenberg;
var aioseopPreviewAutogenerateDescriptions = aioseop_preview_snippet.autogenerateDescriptions;
...
function aioseopUpdateMetabox() {
	...
	if ('false' === aioseopPreviewIsGutenberg) {
		docTitle = $('#title');
		...
		window._wpLoadBlockEditor.then(function() {
			setTimeout(function() {
				...
				wp.data.subscribe(function() {
					clearTimeout(aioseopPreviewTimeout);
					// This is needed because the code otherwise is triggered dozens of times.
					aioseopPreviewTimeout = setTimeout(function() {
						aioseopUpdatePreviewSnippet();
					}, 200);
				});
			});
...
function aioseopUpdatePreviewSnippet() {
	...
	if('on' === aioseopPreviewAutogenerateDescriptions) {
