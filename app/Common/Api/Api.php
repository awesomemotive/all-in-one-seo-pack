...
class Api {
	...
	protected $routes = [
		...
		'POST'   => [
			...
			'ai/schema'                                              => [ 'callback' => [ 'Ai', 'generateSchemas' ], 'access' => 'aioseo_page_ai_content_settings' ],
		...
		'DELETE' => [
			...
			'ai/insights/reports/(?P<uuid>[a-zA-Z0-9-]+)' => [ 'callback' => [ 'AiInsights', 'deleteReport' ], 'access' => 'aioseo_ai_insights_settings' ]
		]
