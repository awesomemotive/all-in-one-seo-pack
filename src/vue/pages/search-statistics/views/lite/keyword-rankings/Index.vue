<template>
	<div class="aioseo-search-statistics-keyword-rankings">
		<blur />

		<cta
			:cta-link="$links.getPricingUrl('search-statistics', 'search-statistics-upsell', 'keyword-rankings')"
			:button-text="strings.ctaButtonText"
			:learn-more-link="$links.getUpsellUrl('search-statistics', 'keyword-rankings', $isPro ? 'pricing' : 'liteUpgrade')"
			:feature-list="[
				strings.feature1,
				strings.feature2,
				strings.feature3,
		...
		>
			...
			<template #description>
				<required-plans :core-feature="[ 'search-statistics', 'keyword-rankings' ]" />
...
<style>
.aioseo-search-statistics-keyword-rankings {
	position: relative;
}
</style>