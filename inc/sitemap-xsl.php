		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				<div id="content">
					<div id="content-head">
						<h1>XML Sitemap</h1>
						<p><?php echo __( 'Generated by', 'all-in-one-seo-pack' ); ?> <a href="https://semperplugins.com/all-in-one-seo-pack-pro-version/?loc=aio_sitemap" target="_blank" rel="noopener noreferrer"><?php echo AIOSEOP_PLUGIN_NAME; ?></a>, <?php echo __( 'this is an XML Sitemap, meant to be consumed by search engines like Google or Bing.', 'all-in-one-seo-pack' ); ?><br/>
