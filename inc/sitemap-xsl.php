		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				<div id="content">
					<div id="content-head">
						<h1>XML Sitemap</h1>
						<p><?php echo __( 'Generated by' ); ?> <a href="https://semperplugins.com/all-in-one-seo-pack-pro-version/?loc=aio_sitemap" target="_blank"><?php echo AIOSEOP_PLUGIN_NAME; ?></a>, <?php echo __( 'this is an XML Sitemap, meant to be consumed by search engines like Google or Bing.' ); ?><br/>
		...
		<table cellpadding="3">
			...
			<tr>
				...
				<xsl:if test="$sitemapType='video'">
					...
					<th><?php echo __( 'Video Thumbnails' ); ?></th>
				</xsl:if>
					<?php
				}
				?>
				<th><?php echo __( 'Priority' ); ?></th>
				<th><?php echo __( 'Change Frequency' ); ?></th>
				<th><?php echo __( 'Last Change' ); ?></th>
			</tr>
			</thead>
			<tbody>
