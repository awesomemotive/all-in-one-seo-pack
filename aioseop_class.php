...
class All_in_One_SEO_Pack extends All_in_One_SEO_Pack_Module {
	...
	function get_post_description( $post ) {
		...
		if ( ! $description ) {
			if ( ! empty( $aioseop_options['aiosp_generate_descriptions'] ) && 'on' === $aioseop_options['aiosp_generate_descriptions'] && empty( $aioseop_options['aiosp_skip_excerpt'] ) && 'on' === $aioseop_options['aiosp_skip_excerpt'] ) {
