	...
	// @codingStandardsIgnoreEnd
		...
		function about_screen() {
			...
			<div class="wrap about-wrap">
				<h1><?php printf( esc_html__( 'Welcome to %1$s %2$s', 'all-in-one-seo-pack' ), AIOSEOP_PLUGIN_NAME, $version ); ?></h1>
				<div
					class="about-text"><?php printf( esc_html__( '%1$s %2$s contains new features, bug fixes, increased security, and tons of under the hood performance improvements.', 'all-in-one-seo-pack' ), AIOSEOP_PLUGIN_NAME, $version ); ?></div>
