...
<div class="welcome-panel">
	<div class="welcome-panel-content">
		<div class="welcome-panel-column-container">
			<div>
				<h3><a href="https://semperplugins.com/all-in-one-seo-pack-3-4/" target="_blank" rel="noopener noreferrer"><?php echo esc_html( __( "Check out what's new in our latest release post!", 'all-in-one-seo-pack' ) ); ?></a></h3>
			</div>
			<div class="welcome-panel-column">
				...
				<p class="call-to-action">
					<a
						...
						target="_blank" rel="noopener noreferrer"><?php echo __( 'Translate', 'all-in-one-seo-pack' ); ?></a></p>
			</div>
