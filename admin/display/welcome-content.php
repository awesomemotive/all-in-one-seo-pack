	...
	<div class="welcome-panel-content">
		<div class="welcome-panel-column-container">
			<div class="welcome-panel-column">
				<h3><?php echo esc_html( sprintf( __( 'Support %s', 'all-in-one-seo-pack' ), AIOSEOP_PLUGIN_NAME ) ); ?></h3>
				<p class="message welcome-icon welcome-edit-page"><?php echo esc_html( sprintf( __( 'There are many ways you can help support %s.', 'all-in-one-seo-pack' ), AIOSEOP_PLUGIN_NAME ) ); ?></p>
				<p class="message aioseop-message welcome-icon welcome-edit-page"><?php echo esc_html( sprintf( __( 'Upgrade to %s to access priority support and premium features.', 'all-in-one-seo-pack' ), 'All in One SEO Pack Pro' ) ); ?></p>
				...
				<p class="message aioseop-message welcome-icon welcome-edit-page"><?php echo esc_html( sprintf( __( 'Help translate %s into your language.', 'all-in-one-seo-pack' ), AIOSEOP_PLUGIN_NAME ) ); ?></p>
				<p class="call-to-action"><a
			...
			<div class="welcome-panel-column">
				...
				<ul>
					<li><a href="https://semperplugins.com/documentation/quick-start-guide/"
						   target="_blank"
						   class="welcome-icon welcome-add-page"><?php echo sprintf( __( 'Beginners Guide for %s', 'all-in-one-seo-pack' ), AIOSEOP_PLUGIN_NAME ); ?></a>
