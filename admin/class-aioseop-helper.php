...
class AIOSEOP_Helper {
	...
	private function help_text_general() {
		...
		$rtn_help_text = array(
			...
			// Title Settings.
			'aiosp_rewrite_titles'              => __( "If enabled, all of your title and meta description tags will be rewritten, regardless of whether they were automatically generated by the plugin or entered by you manually. You can specify the title format for each post type or taxonomy below, as well as the description format.<br/><br/>For instance, all post titles will be rewritten as 'Post Title | Site Name' by default if you have this setting enabled. You can adjust each title format with your own text or by using our macros.", 'all-in-one-seo-pack' ),
			'aiosp_home_page_title_format'      =>
				...
				'<dl>' .
					...
					'<dt>%cf_fieldname%</dt>' .
					'<dd>' . __( 'The name of the custom field', 'all-in-one-seo-pack' ) . '</dd>' .
				'</dl>',
			'aiosp_page_title_format'           =>
				...
				'<dl>' .
					...
					'<dd>' . __( 'The current year', 'all-in-one-seo-pack' ) . '</dd>' .
					'<dt>%post_date%</dt>' .
					'<dd>' . __( 'The date the page was published (localized)', 'all-in-one-seo-pack' ) . '</dd>' .
					'<dt>%post_year%</dt>' .
					'<dd>' . __( 'The year the page was published (localized)', 'all-in-one-seo-pack' ) . '</dd>' .
					'<dt>%post_month%</dt>' .
					'<dd>' . __( 'The month the page was published (localized)', 'all-in-one-seo-pack' ) . '</dd>' .
					'<dt>%cf_fieldname%</dt>' .
					'<dd>' . __( 'The name of the custom field', 'all-in-one-seo-pack' ) . '</dd>' .
				'</dl>',
			'aiosp_post_title_format'           =>
				...
				'<dl>' .
					...
					'<dd>' . __( 'Your site description', 'all-in-one-seo-pack' ) . '</dd>' .
					'<dt>%post_title%</dt>' .
					'<dd>' . __( 'The original title of the post', 'all-in-one-seo-pack' ) . '</dd>' .
					...
					'<dd>' . __( 'The current year', 'all-in-one-seo-pack' ) . '</dd>' .
					'<dt>%post_date%</dt>' .
					'<dd>' . __( 'The date the post was published (localized)', 'all-in-one-seo-pack' ) . '</dd>' .
					'<dt>%post_year%</dt>' .
					'<dd>' . __( 'The year the post was published (localized)', 'all-in-one-seo-pack' ) . '</dd>' .
					'<dt>%post_month%</dt>' .
					'<dd>' . __( 'The month the post was published (localized)', 'all-in-one-seo-pack' ) . '</dd>' .
					'<dt>%cf_fieldname%</dt>' .
					'<dd>' . __( 'The name of the custom field', 'all-in-one-seo-pack' ) . '</dd>' .
				'</dl>',
			'aiosp_category_title_format'       =>
				...
				'<dl>' .
					...
					'<dd>' . __( 'The description of the category', 'all-in-one-seo-pack' ) . '</dd>' .
					'<dt>%current_year%</dt>' .
					'<dd>' . __( 'The current year', 'all-in-one-seo-pack' ) . '</dd>' .
				'</dl>',
			'aiosp_archive_title_format'        =>
				...
				'<dl>' .
					...
					'<dd>' . __( 'Your site description', 'all-in-one-seo-pack' ) . '</dd>' .
					'<dt>%archive_title%</dt>' .
					'<dd>' . __( 'The original archive title', 'all-in-one-seo-pack' ) . '</dd>' .
				'</dl>',
			...
			'aiosp_tag_title_format'            =>
				...
				'<dl>' .
					...
					'<dd>' . __( 'Your site description', 'all-in-one-seo-pack' ) . '</dd>' .
					'<dt>%tag%</dt>' .
					'<dd>' . __( 'The name of the tag', 'all-in-one-seo-pack' ) . '</dd>' .
				'</dl>',
			...
			'aiosp_description_format'          =>
				...
				'<dl>' .
					...
					'<dd>' . __( 'The current year', 'all-in-one-seo-pack' ) . '</dd>' .
					'<dt>%post_date%</dt>' .
					'<dd>' . __( 'The date the page/post was published (localized)', 'all-in-one-seo-pack' ) . '</dd>' .
					'<dt>%post_year%</dt>' .
					'<dd>' . __( 'The year the page/post was published (localized)', 'all-in-one-seo-pack' ) . '</dd>' .
					'<dt>%post_month%</dt>' .
					'<dd>' . __( 'The month the page/post was published (localized)', 'all-in-one-seo-pack' ) . '</dd>' .
					'<dt>%cf_fieldname%</dt>' .
					'<dd>' . __( 'The name of the custom field', 'all-in-one-seo-pack' ) . '</dd>' .
				'</dl>',
		...
		foreach ( $post_types as $v1_pt ) {
			if ( ! isset( $rtn_help_text[ 'aiosp_' . $v1_pt . '_title_format' ] ) ) {
				...
				foreach ( $pt_obj_taxes as $k2_slug => $v2_tax_obj ) {
					$help_text_macros .= sprintf( __( "%%tax_%1\$s%% - This post's associated %2\$s taxonomy title", 'all-in-one-seo-pack' ), $k2_slug, $v2_tax_obj->label );
				}
