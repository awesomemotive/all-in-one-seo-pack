...
class AIOSEOP_Helper {
	 ...
	 * @since 2.4.2
	 *
	 * @param type $module Module/Class name.
	 */
	...
	private function _set_help_text( $module ) {
		...
		switch ( $module ) {
			case 'All_in_One_SEO_Pack':
				$this->help_text = $this->_help_text_general();
				$this->help_text = array_merge( $this->help_text, $this->_help_text_post_meta() );
				break;
			case 'All_in_One_SEO_Pack_Performance':
				$this->help_text = $this->_help_text_performance();
				break;
			case 'All_in_One_SEO_Pack_Sitemap':
				$this->help_text = $this->_help_text_sitemap();
				break;
			case 'All_in_One_SEO_Pack_Opengraph':
				$this->help_text = $this->_help_text_opengraph();
				break;
			case 'All_in_One_SEO_Pack_Robots':
				$this->help_text = $this->_help_text_robots_generator();
				break;
			case 'All_in_One_SEO_Pack_File_Editor':
				$this->help_text = $this->_help_text_file_editor();
				break;
			case 'All_in_One_SEO_Pack_Importer_Exporter':
				$this->help_text = $this->_help_text_importer_exporter();
				break;
			case 'All_in_One_SEO_Pack_Bad_Robots':
				$this->help_text = $this->_help_text_bad_robots();
				break;
			default:
				$this->help_text = array_merge( $this->help_text, $this->_help_text_general() );
				$this->help_text = array_merge( $this->help_text, $this->_help_text_performance() );
				$this->help_text = array_merge( $this->help_text, $this->_help_text_sitemap() );
				$this->help_text = array_merge( $this->help_text, $this->_help_text_opengraph() );
				$this->help_text = array_merge( $this->help_text, $this->_help_text_robots_generator() );
				$this->help_text = array_merge( $this->help_text, $this->_help_text_file_editor() );
				$this->help_text = array_merge( $this->help_text, $this->_help_text_importer_exporter() );
				$this->help_text = array_merge( $this->help_text, $this->_help_text_bad_robots() );
				$this->help_text = array_merge( $this->help_text, $this->_help_text_post_meta() );
				break;
		}
	 ...
	 * @return string
	 */
	private function _help_text_general() {
		$rtn_help_text =  array(
	 ...
	 * @return string
	 */
	private function _help_text_performance() {
		return array(
	 ...
	 * @return string
	 */
	private function _help_text_sitemap() {
		$rtn_help_text = array(
			'aiosp_sitemap_filename'         => __( 'Specifies the name of your sitemap file. This will default to "sitemap".', 'all-in-one-seo-pack' ),
	 ...
	 * @return string
	 */
	private function _help_text_opengraph() {
		$rtn_help_text = array(
	 ...
	 * @return string
	 */
	private function _help_text_robots_generator() {
		return array(
			'aiosp_robots_generator_additional'  => __( 'Rule Type', 'all-in-one-seo-pack' ),
			'aiosp_robots_generator_useragent'   => __( 'User Agent', 'all-in-one-seo-pack' ),
			'aiosp_robots_generator_path'        => __( 'Directory Path', 'all-in-one-seo-pack' ),
			'aiosp_robots_generator_robotgen'    => __( 'Robots.txt editor', 'all-in-one-seo-pack' ),
		);
	}
	 ...
	 * @return string
	 */
	private function _help_text_file_editor() {
		return array(
	 ...
	 * @return string
	 */
	private function _help_text_importer_exporter() {
		return array(
	 ...
	 * @return string
	 */
	private function _help_text_bad_robots() {
		return array(
	 ...
	 * @return string
	 */
	private function _help_text_post_meta() {
		return array(
	 ...
	 * @since 2.4.2
	 *
	 * @param type $slug Module option slug.
	 * @return string
	 */
